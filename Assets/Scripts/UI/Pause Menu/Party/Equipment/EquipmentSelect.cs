...
public class EquipmentSelect : MonoBehaviour
{
    ...
    //    foreach (InventoryItem inventoryItem in inventory.GetEquipment())
    //    {
    //        EquipmentObject equipmentObject = (EquipmentObject)inventoryItem.itemObject;
    //        if (equipmentObject && equipmentObject.equipmentType == selectedEquipmentSlot.equipmentType)
    //        {
    //            CreateSlot(inventoryItem.itemObject, inventoryItem.count);
    //        }
    //    }
